...
section_banner(ws3, 12, 1, 4, "OLS REGRESSION SUMMARY (see 'OLS Regression' sheet)")
...
ols_rows = [
    ...
    ("R² (variance explained)",
     ...
     "Goodness of fit — proportion of variance explained by year"),
    ("p-value (two-tailed)",
     "='OLS Regression'!B14", "0.0000",
     "Statistical significance; <0.05 = significant trend"),
    ("n (observations)",
...
section_banner(ws3, 19, 1, 4, "RESEARCH CONTEXT")
...
context_notes = [
    ...
    ("Limitations",
     "n=7 for OLS (low statistical power). 2024 HHI affected by Synergy's Azure "
     "reclassification. 2018–2021 shares interpolated, not confirmed from primary "
     "Synergy press releases. All limitations noted explicitly in paper methodology."),
]

for n_idx, (label, text) in enumerate(context_notes, 20):
